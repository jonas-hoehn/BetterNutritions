...
data class Product(
    ...
    val additives_n: Double,
    val additives_old_n: Double,
    ...
    val ingredients_from_or_that_may_be_from_palm_oil_n: Double,
    val ingredients_from_palm_oil_n: Double,
    val ingredients_from_palm_oil_tags: List<Any>,
    val ingredients_hierarchy: List<String>,
    val ingredients_n: Double,
    val ingredients_n_tags: List<String>,
    val ingredients_original_tags: List<String>,
    val ingredients_percent_analysis: Double,
    ...
    val ingredients_that_may_be_from_palm_oil_n: Double,
    val ingredients_that_may_be_from_palm_oil_tags: List<Any>,
    val ingredients_with_specified_percent_n: Double,
    val ingredients_with_specified_percent_sum: Double,
    val ingredients_with_unspecified_percent_n: Double,
    val ingredients_with_unspecified_percent_sum: Double,
    val interface_version_created: String,
    val interface_version_modified: String,
    val known_ingredients_n: Double,
    val labels: String,
    ...
    val last_image_t: Double,
    val last_modified_by: String,
    val last_modified_t: Double,
    val lc: String,
    val link: String,
    ...
    val nutriscore_score: Double,
    val nutriscore_score_opposite: Double,
    ...
    val nutrition_score_beverage: Double,
    val nutrition_score_debug: String,
    val nutrition_score_warning_fruits_vegetables_nuts_estimate_from_ingredients: Double,
    val nutrition_score_warning_fruits_vegetables_nuts_estimate_from_ingredients_value: Double,
    val nutrition_score_warning_no_fiber: Double,
    val origin: String,
    ...
    val unique_scans_n: Double,
    val unknown_ingredients_n: Double,
